...
public:
    ...
    static TreePtr Send0Block(core::LocOffsets loc, TreePtr recv, core::NameRef fun,
                                                 TreePtr blk) {
        Send::ARGS_store nargs;
    ...
    static TreePtr Send2(core::LocOffsets loc, TreePtr recv, core::NameRef fun, TreePtr arg1,
                                            TreePtr arg2) {
        Send::ARGS_store nargs;
        nargs.emplace_back(std::move(arg1));
    ...
    static TreePtr Send3(core::LocOffsets loc, TreePtr recv, core::NameRef fun, TreePtr arg1,
                                            TreePtr arg2, TreePtr arg3) {
        Send::ARGS_store nargs;
        nargs.emplace_back(std::move(arg1));
        nargs.emplace_back(std::move(arg2));
    ...
    static TreePtr OptionalArg(core::LocOffsets loc, TreePtr inner,
                                                         TreePtr default_) {
    ...
    static TreePtr CallWithSplat(core::LocOffsets loc, TreePtr recv, core::NameRef name,
                                                    TreePtr args) {
    ...
    static TreePtr UnresolvedConstant(core::LocOffsets loc, TreePtr scope,
                                                                     core::NameRef name) {
    ...
    static TreePtr Method(core::LocOffsets loc, core::Loc declLoc, core::NameRef name,
    ...
    static TreePtr SyntheticMethod0(core::LocOffsets loc, core::Loc declLoc, core::NameRef name,
                                                       TreePtr rhs) {
        MethodDef::ARGS_store args;
        return SyntheticMethod(loc, declLoc, name, std::move(args), std::move(rhs));
    }

    static TreePtr SyntheticMethod1(core::LocOffsets loc, core::Loc declLoc, core::NameRef name,
                                                       TreePtr arg0, TreePtr rhs) {
        MethodDef::ARGS_store args;
    ...
    static TreePtr Class(core::LocOffsets loc, core::Loc declLoc, TreePtr name,
                                           ClassDef::ANCESTORS_store ancestors, ClassDef::RHS_store rhs) {
        return MK::ClassOrModule(loc, declLoc, std::move(name), std::move(ancestors), std::move(rhs),
                                 ClassDef::Kind::Class);
    }

    static TreePtr Module(core::LocOffsets loc, core::Loc declLoc, TreePtr name,
                                            ClassDef::ANCESTORS_store ancestors, ClassDef::RHS_store rhs) {
        return MK::ClassOrModule(loc, declLoc, std::move(name), std::move(ancestors), std::move(rhs),
    ...
    static ast::Local *arg2Local(Expression *arg) {
        while (true) {
            if (auto *local = static_cast<ast::Local*>(arg)) {
